...
timestamp 当前的精确到秒的Unix时间戳4个字节, 时区 1个字节有符号 -1～-11 0～+12 共24个时区 设备没有时区字段可缺省
...
<== 0x71| {"data":{
        ...
        "ble_protocol_ver":20,            //ble 协议版本 2个字节
...
<== 0x76|isRecording[1]|isCharging[1]|bound[1]|isPrivacy[1]
